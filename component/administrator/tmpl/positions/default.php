...
use Joomla\Component\Volunteers\Administrator\View\Positions\HtmlView;
...
<form action="<?php echo Route::_('index.php?option=com_volunteers&view=positions'); ?>" method="post" name="adminForm" id="adminForm">
    <div id="j-main-container" class="j-main-container">
        ...
        <?php else : ?>
        <h3><?php echo count($this->items); ?> positions (matching filters)</h3>
