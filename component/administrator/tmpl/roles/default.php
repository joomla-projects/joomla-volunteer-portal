...
<form action="<?php echo Route::_('index.php?option=com_volunteers&view=roles'); ?>" method="post" name="adminForm" id="adminForm">
 <div id="j-main-container" class="j-main-container">
        <?php echo LayoutHelper::render('joomla.searchtools.default', ['view' => $this]); ?>
            ...
            <?php else : ?>
            <h3><?php echo count($this->items); ?> roles (matching filters)</h3>
