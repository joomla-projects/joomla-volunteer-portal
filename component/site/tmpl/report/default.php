...
<div class="row-fluid report">
    <div class="span2 volunteer-image">
        <a href="<?php echo Route::_('index.php?option=com_volunteers&view=volunteer&id=' . $this->item->volunteer_id) ?>">
    ...
    <div class="span10">
        <div class="filter-bar">
            <?php if ($this->acl->edit || ($this->item->created_by == $this->user->id)) : ?>
                <a class="btn pull-right" href="<?php echo Route::_('index.php?option=com_volunteers&task=report.edit&id=' . $this->item->id) ?>">
        ...
        <p class="muted">
            ...
            <a href="<?php echo Route::_('index.php?option=com_volunteers&view=volunteer&id=' . $this->item->volunteer_id) ?>"><?php echo $this->item->volunteer_name; ?></a>
