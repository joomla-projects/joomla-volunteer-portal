    ...
    <div class="volunteers">
        <div class="row-fluid">
            <div class="filter-bar">
                <div class="btn-group pull-right">
                    ...
                    <div class="input-append">
                        <input type="text" name="filter_search" id="filter-search" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" class="inputbox" onchange="document.adminForm.submit();" placeholder="<?php echo Text::_('COM_VOLUNTEERS_SEARCH_VOLUNTEER'); ?>"/>
                        <button class="btn btn-primary" type="submit" value="<?php echo Text::_('COM_VOLUNTEERS_SEARCH_VOLUNTEER'); ?>">
            ...
            <div class="page-header">
                <h1><?php echo Text::_('COM_VOLUNTEERS_TITLE_VOLUNTEERS') ?></h1>
            </div>
        </div>
